...
class usuarioControlador extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$usuario) {
          ...
          // Asignar la autorización (rol) al usuario recién creado
        DB::table('autorizacion_usuario')->insert([
            'id_autorizacion' => $request->id_autorizacion,
            'id_sistema_usuario' => $usuario->id
        ]);
    ...
    public function update(Request $request, $id)
    {
      ...
      // Si se envía una nueva autorización, crear o actualizar la relación
if ($request->filled('id_autorizacion')) {
    DB::table('autorizacion_usuario')->updateOrInsert(
        ['id_sistema_usuario' => $id],
        ['id_autorizacion' => $request->id_autorizacion]
    );
}
